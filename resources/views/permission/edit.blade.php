...
@section('content')
<div>
    <a href="{{route('permissionManangement.index')}}"><input type="button" name="" class="btn btn-primary mb-2" value="Back" id=""></a>
</div>
    <div class="card">
        <div class="card-body">
            <form action="{{route('permissionManangement.update',$permission->id)}}" method="POST" id="update-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
<div class="row">
...
@section('script')
 {{!!JsValidator::formRequest('App\Http\Requests\PermissionUpdateForm', '#update-form');!!}}
    <script>
