                ...
                @foreach ($permissions as $user)
                    <tr>
                        ...
                        <td>
                              ...
                              <form action="{{route('permissionManangement.destroy',$user->id)}}" method="POST" style="display:inline;">
                            @csrf @method('DELETE')
                            ...
                            <a href="{{route('permissionManangement.edit',$user->id)}}" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
