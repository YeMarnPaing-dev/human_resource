                ...
                @foreach ($departments as $user)
                    <tr>
                        ...
                        <td>
                              ...
                              <form action="{{route('departmentManangement.destroy',$user->id)}}" method="POST" style="display:inline;">
                            @csrf @method('DELETE')
                            ...
                            <a href="{{route('departmentManangement.edit',$user->id)}}" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
